 ...
 ********************************************************************************/
	...
	if($chart_type == 'grid'){
		$widget_markup = la_display_grid($dbh,$access_key);
	}else{
		$widget_markup = la_display_chart($dbh,$access_key);
	}
?>
<!DOCTYPE html>
<html>
	<head>
	<title><?php echo noHTML($chart_title); ?></title>
	<meta charset="utf-8">
...
?>;
 color: <?php echo $entry_link_color;
?> !important;
