 ...
 ********************************************************************************/
	...
	$theme_id 	= (int) la_sanitize($_REQUEST['theme_id']);
	...
	if(empty($_SESSION['la_user_privileges']['priv_new_themes'])){
		$_SESSION['LA_DENIED'] = "You don't have permission to create/edit themes.";
	...
	if(empty($theme_id)){
		...
		$theme_properties->logo_default_image = 'itauditmachine.png';
		...
		if(!empty($row['theme_built_in'])){
			...
			$_SESSION['LA_DENIED'] = "You don't have permission to edit built-in themes.";
		...
		if(empty($_SESSION['la_user_privileges']['priv_administer'])){
			if($row['user_id'] != $_SESSION['la_user_id']){
				$_SESSION['LA_DENIED'] = "You don't have permission to edit this theme.";
	...
	if(empty($theme_id)){
		...
		if(empty($theme_properties->theme_is_private)){
			$page_title .= ' <span style="font-size: 70%;color: #80b638">(public)</span>';
		}
	...
	if(!empty($_SESSION['la_user_privileges']['priv_administer'])){
		$query = "SELECT count(*) as total_row FROM ".LA_TABLE_PREFIX."form_themes WHERE theme_built_in=0 and status=1";
		$params = array();
	}else{
		$query = "SELECT count(*) as total_row FROM ".LA_TABLE_PREFIX."form_themes WHERE theme_built_in=0 and status=1 and user_id=?";
	...
	if(!empty($total_custom_themes)){
		...
		if(!empty($_SESSION['la_user_privileges']['priv_administer'])){
			$query = "SELECT theme_id,theme_name,theme_is_private FROM ".LA_TABLE_PREFIX."form_themes WHERE theme_built_in=0 and status=1 ORDER BY theme_name ASC";
			$params = array();
		}else{
			$query = "SELECT theme_id,theme_name,theme_is_private FROM ".LA_TABLE_PREFIX."form_themes WHERE theme_built_in=0 and status=1 and user_id=? ORDER BY theme_name ASC";
			$params = array($_SESSION['la_user_id']);
		}
	...
	$query = "SELECT count(*) as total_row FROM ".LA_TABLE_PREFIX."form_themes WHERE theme_built_in=1 and status=1";
	...
	while($row = la_do_fetch_result($sth)){
		...
		$font_link_markup = la_theme_get_fonts_link($dbh,$theme_builtin_properties->theme_id);
...
<div id="theme_editor_loading"> Loading... Please wait... </div>
    ...
    <div id="et_theme_buttons">
      <div id="et_theme_buttons_title">
        ...
        <div id="dropui_theme_options" style="float: right;">
          <div class="dropui dropuiquick dropui-icon dropui-menu dropui-pink dropui-right"> <a href="javascript:;" class="dropui-tab"> Theme Options </a>
            <div class="dropui-content">
              <ul>
                ...
                <?php } ?>
                <?php }} ?>
                <?php echo $custom_themes_list_markup; ?> <?php echo $builtin_themes_list_markup; ?>
              </ul>
            </div>
          </div>
        </div>
        <div style="float: right;margin-right: 5px"> <a href="#" id="button_save_theme" class="bb_button bb_small bb_green"><img src="images/navigation/FFFFFF/24x24/Save_theme.png"> Save Theme </a> </div>
        <?php } ?>
        <div style="clear: both; height: 1px"></div>
      </div>
      <div id="et_theme_buttons_tab" style="text-align: center; clear: both; padding-top: 20px;">
    ...
    <div id="et_theme_preview" <?php echo $form_wallpaper_style_tag; ?> >
      <div id="main_body">
        <div id="form_container" class="<?php echo $form_container_class; ?>" <?php echo $form_container_style_tag; ?>>
          ...
          <form id="form_theme_preview" class="itauditm top_label" method="post" action="#main_body">
        ...
        <!-- start drop buttons -->
        <div id="dropui-form-logo" class="dropui dropui-blue dropui-circle dropui-left et-prop-logo"> <img src="images/arrows/arrow_left_blue.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">A</a>
          <div class="dropui-content" style="width: 500px">
            <div class="dropui-content-header"> <img src="images/icons/257.png" class="dropui-header-img" />
              <h6>Form Logo</h6>
            ...
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_logo">
                  <li>
                    <input type="radio" title="Your Logo" name="et_form_logo" id="et_form_logo_custom" />
                    <label for="et_form_logo_custom">Your Logo</label>
                  </li>
                  <li class="prop_selected">
                    <input type="radio" title="Default Logo" name="et_form_logo" id="et_form_logo_default" />
                    <label for="et_form_logo_default">Default Logo</label>
                  </li>
                  <li>
                    <input type="radio" title="None" name="et_form_logo" id="et_form_logo_none" />
                    <label for="et_form_logo_none">None</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_logo_content">
                <div id="et_form_logo_custom_tab" style="display: none">
                  ...
                  <div id="et_form_logo_advanced" style="display: none"> <span style="display: block">
                    ...
                    <span style="font-size: 90%; margin-top: 3px;display: block">(maximum width: 640px)</span> </span> <span style="display: block;padding-top: 10px">
                    <label for="et_your_logo_height">Height: </label>
                    <input type="text" size="4" value="" class="text" name="et_your_logo_height" id="et_your_logo_height" />
                    px </span> <span style="display: block;padding-top: 10px">
                    <input type="button" class="button_text" value="Apply" id="et_your_logo_submit" />
                    </span> </div>
                  <div style="margin-top: 10px;padding-right: 5px;text-align: right"> <a id="et_form_logo_more" href="#">more options</a> </div>
                </div>
                <div id="et_form_logo_default_tab">
                  ...
                  <select class="select" size="15" id="et_logo_default_dropdown" name="et_logo_default_dropdown" style="height: 120px; width: 265px">
                    <option value="itauditmachine.png">IT Audit Machine</option>
                    <option value="">--------------</option>
                    <option value="logo1.jpg">ITAM Easy</option>
                    <option value="logo2.jpg">Newspaper</option>
                    <option value="logo3.jpg">Clock</option>
                    <option value="logo4.jpg">Credit Cards</option>
                    <option value="logo5.jpg">Earth</option>
                    <option value="logo6.jpg">Cybervisor</option>
                  </select>
                </div>
                <div id="et_form_logo_none_tab" style="display: none"> <img src="images/icons/disabled_white.png"/>
                  <h3 style="padding-top: 10px">Logo Disabled</h3>
                </div>
              </div>
              <div style="clear: both; height: 0px"></div>
            </div>
            <!-- end dropui-content-main -->
          </div>
          <!-- end dropui-content -->
        </div>
        <!-- end dropui-form-logo -->

        <div id="dropui-bg-main" class="dropui dropui-green dropui-circle dropui-left et-prop-bg"> <img src="images/arrows/arrow_down_green.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">A</a>
          <div class="dropui-content" style="width: 515px">
            <div class="dropui-content-header"> <img src="images/icons/26.png" class="dropui-header-img" />
              <h6>Wallpaper</h6>
              <a href="#" class="dropui-close"><img src="images/icons/52.png" /></a>
              <div class="dropui-header-clear"></div>
            </div>
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_wallpaper">
                  <li class="prop_selected">
                    <input type="radio" name="et_form_wallpaper" id="et_form_wallpaper_color" />
                    <label for="et_form_wallpaper_color">Color</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_wallpaper" id="et_form_wallpaper_pattern" />
                    <label for="et_form_wallpaper_pattern">Pattern</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_wallpaper" id="et_form_wallpaper_custom" />
                    <label for="et_form_wallpaper_custom">Custom Image</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_wallpaper_content">
                <div id="et_form_wallpaper_color_tab" >
                  <div class="color_picker_tab"> <?php echo get_color_picker_markup(); ?> </div>
                ...
                <div id="et_form_wallpaper_pattern_tab" style="display: none">
                  <div class="pattern_tab"> <?php echo get_pattern_picker_markup(); ?> </div>
                ...
                <div id="et_form_wallpaper_custom_tab" style="display: none">
                  ...
                  <div id="et_wallpaper_custom_bg_advanced" style="display: none"> <span style="display: block">
                    ...
                    </span> <span style="display: block;padding-top: 10px">
                    <input type="button" class="button_text" value="Apply" id="et_wallpaper_custom_bg_submit" />
                    </span> </div>
                  <div style="margin-top: 10px;padding-right: 5px;text-align: right"> <a id="et_wallpaper_custom_bg_more" href="#">more options</a> </div>
                </div>
              </div>
              <div style="clear: both; height: 0px"></div>
            </div>
        ...
        <div id="dropui-bg-header" class="dropui dropui-green dropui-circle dropui-right et-prop-bg"> <img src="images/arrows/arrow_right_green.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">B</a>
          <div class="dropui-content" style="width: 515px">
            <div class="dropui-content-header"> <img src="images/icons/26.png" class="dropui-header-img" />
            ...
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_headerbg">
                  <li class="prop_selected">
                    <input type="radio" name="et_form_headerbg" id="et_form_headerbg_color" />
                    <label for="et_form_headerbg_color">Color</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_headerbg" id="et_form_headerbg_pattern" />
                    <label for="et_form_headerbg_pattern">Pattern</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_headerbg" id="et_form_headerbg_custom" />
                    <label for="et_form_headerbg_custom">Custom Image</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_headerbg_content">
                ...
                <div id="et_form_headerbg_custom_tab" style="display: none">
                  ...
                  <div id="et_headerbg_custom_bg_advanced" style="display: none"> <span style="display: block">
                  ...
                  <div style="margin-top: 10px;padding-right: 5px;text-align: right"> <a id="et_headerbg_custom_bg_more" href="#">more options</a> </div>
                </div>
              </div>
              <div style="clear: both; height: 0px"></div>
            </div>
        ...
        <!-- end dropui-bg-header -->

        <div id="dropui-bg-form" class="dropui dropui-green dropui-circle dropui-right et-prop-bg"> <img src="images/arrows/arrow_right_medium_green.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">C</a>
          <div class="dropui-content" style="width: 515px">
            <div class="dropui-content-header"> <img src="images/icons/26.png" class="dropui-header-img" />
            ...
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_formbg">
                  <li class="prop_selected">
                    <input type="radio" name="et_form_formbg" id="et_form_formbg_color" />
                    <label for="et_form_formbg_color">Color</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_formbg" id="et_form_formbg_pattern" />
                    <label for="et_form_formbg_pattern">Pattern</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_formbg" id="et_form_formbg_custom" />
                    <label for="et_form_formbg_custom">Custom Image</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_formbg_content">
                ...
                <div id="et_form_formbg_custom_tab" style="display: none">
                  ...
                  <div id="et_form_formbg_custom_advanced" style="display: none"> <span style="display: block">
                  ...
                  <div style="margin-top: 10px;padding-right: 5px;text-align: right"> <a id="et_form_formbg_custom_more" href="#">more options</a> </div>
                </div>
              </div>
              <div style="clear: both; height: 0px"></div>
            </div>
        ...
        <div id="dropui-bg-highlight" class="dropui dropui-green dropui-circle dropui-right et-prop-bg"> <img src="images/arrows/arrow_diagonal_bottom_right_green.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">D</a>
          <div class="dropui-content" style="width: 515px">
            <div class="dropui-content-header"> <img src="images/icons/26.png" class="dropui-header-img" />
            ...
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_highlightbg">
                  <li class="prop_selected">
                    <input type="radio" name="et_form_highlightbg" id="et_form_highlightbg_color" />
                    <label for="et_form_highlightbg_color">Color</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_highlightbg" id="et_form_highlightbg_pattern" />
                    <label for="et_form_highlightbg_pattern">Pattern</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_highlightbg" id="et_form_highlightbg_custom" />
                    <label for="et_form_highlightbg_custom">Custom Image</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_highlightbg_content">
                ...
                <div id="et_form_highlightbg_custom_tab" style="display: none">
                  ...
                  <div id="et_form_highlightbg_custom_advanced" style="display: none"> <span style="display: block">
                  ...
                  <div style="margin-top: 10px;padding-right: 5px;text-align: right"> <a id="et_form_highlightbg_custom_more" href="#">more options</a> </div>
                </div>
              </div>
              <div style="clear: both; height: 0px"></div>
            </div>
        ...
        <!-- end dropui-bg-highlight -->

        <div id="dropui-bg-guidelines" class="dropui dropui-green dropui-circle dropui-right et-prop-bg"> <img src="images/arrows/arrow_right_green.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">E</a>
          <div class="dropui-content" style="width: 515px">
            <div class="dropui-content-header"> <img src="images/icons/26.png" class="dropui-header-img" />
            ...
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_guidelinesbg">
                  <li class="prop_selected">
                    <input type="radio" name="et_form_guidelinesbg" id="et_form_guidelinesbg_color" />
                    <label for="et_form_guidelinesbg_color">Color</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_guidelinesbg" id="et_form_guidelinesbg_pattern" />
                    <label for="et_form_guidelinesbg_pattern">Pattern</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_guidelinesbg" id="et_form_guidelinesbg_custom" />
                    <label for="et_form_guidelinesbg_custom">Custom Image</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_guidelinesbg_content">
                ...
                <div id="et_form_guidelinesbg_custom_tab" style="display: none">
                  ...
                  <div id="et_form_guidelinesbg_custom_advanced" style="display: none"> <span style="display: block">
                  ...
                  <div style="margin-top: 10px;padding-right: 5px;text-align: right"> <a id="et_form_guidelinesbg_custom_more" href="#">more options</a> </div>
                </div>
              </div>
              <div style="clear: both; height: 0px"></div>
            </div>
        ...
        <!-- end dropui-bg-guidelines -->

        <div id="dropui-bg-field" class="dropui dropui-green dropui-circle dropui-left et-prop-bg"> <img src="images/arrows/arrow_left_green.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">F</a>
          <div class="dropui-content" style="width: 515px">
            <div class="dropui-content-header"> <img src="images/icons/26.png" class="dropui-header-img" />
            ...
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_fieldbg">
                  <li class="prop_selected">
                    <input type="radio" name="et_form_fieldbg" id="et_form_fieldbg_color" />
                    <label for="et_form_fieldbg_color">Color</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_fieldbg" id="et_form_fieldbg_pattern" />
                    <label for="et_form_fieldbg_pattern">Pattern</label>
                  </li>
                  <li>
                    <input type="radio" name="et_form_fieldbg" id="et_form_fieldbg_custom" />
                    <label for="et_form_fieldbg_custom">Custom Image</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_fieldbg_content">
                ...
                <div id="et_form_fieldbg_custom_tab" style="display: none">
                  ...
                  <div id="et_form_fieldbg_custom_advanced" style="display: none"> <span style="display: block">
                  ...
                  <div style="margin-top: 10px;padding-right: 5px;text-align: right"> <a id="et_form_fieldbg_custom_more" href="#">more options</a> </div>
                </div>
              </div>
              <div style="clear: both; height: 0px"></div>
            </div>
        ...
        <div id="dropui-typo-form-title" class="dropui dropui-orange dropui-circle dropui-left et-prop-typo"> <img src="images/arrows/arrow_left_orange.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">A</a>
          <div class="dropui-content" style="width: 507px">
            <div class="dropui-content-header"> <img src="images/icons/28.png" class="dropui-header-img" />
              <h6>Form Title</h6>
              <a href="#" class="dropui-close"><img src="images/icons/52.png" /></a>
              <div class="dropui-header-clear"></div>
            </div>
            <div class="dropui-content-main">
              ...
              <div id="et_typo_form_title_content">
                <div id="et_li_typo_form_title_font_tab">
                  <div class="font_picker_tab"> <?php echo get_font_picker_markup(); ?> </div>
        ...
        <!-- end dropui-typo-form-title -->

        <div id="dropui-typo-form-desc" class="dropui dropui-orange dropui-circle dropui-right et-prop-typo"> <img src="images/arrows/arrow_right_orange_long.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">B</a>
          <div class="dropui-content" style="width: 507px">
            <div class="dropui-content-header"> <img src="images/icons/28.png" class="dropui-header-img" />
        ...
        <!-- end dropui-typo-form-desc -->

        <div id="dropui-typo-field-title" class="dropui dropui-orange dropui-circle dropui-left et-prop-typo"> <img src="images/arrows/arrow_left_orange.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">C</a>
          <div class="dropui-content" style="width: 507px">
            <div class="dropui-content-header"> <img src="images/icons/28.png" class="dropui-header-img" />
              <h6>Field Label</h6>
              <a href="#" class="dropui-close"><img src="images/icons/52.png" /></a>
        ...
        <!-- end dropui-typo-field-title -->

        <div id="dropui-typo-guidelines" class="dropui dropui-orange dropui-circle dropui-right et-prop-typo"> <img src="images/arrows/arrow_right_orange.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">D</a>
          <div class="dropui-content" style="width: 507px">
            <div class="dropui-content-header"> <img src="images/icons/28.png" class="dropui-header-img" />
        ...
        <!-- end dropui-typo-guidelines -->

        <div id="dropui-typo-section-title" class="dropui dropui-orange dropui-circle dropui-left et-prop-typo"> <img src="images/arrows/arrow_left_orange.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">E</a>
          <div class="dropui-content" style="width: 507px">
            <div class="dropui-content-header"> <img src="images/icons/28.png" class="dropui-header-img" />
        ...
        <!-- end dropui-typo-section-title -->

        <div id="dropui-typo-section-desc" class="dropui dropui-orange dropui-circle dropui-left et-prop-typo"> <img src="images/arrows/arrow_bottom_left_orange.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">F</a>
          <div class="dropui-content" style="width: 507px">
            <div class="dropui-content-header"> <img src="images/icons/28.png" class="dropui-header-img" />
        ...
        <!-- end dropui-typo-section-desc -->

        <div id="dropui-typo-field-text" class="dropui dropui-orange dropui-circle dropui-right et-prop-typo"> <img src="images/arrows/arrow_right_orange.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">G</a>
          <div class="dropui-content" style="width: 507px">
            <div class="dropui-content-header"> <img src="images/icons/28.png" class="dropui-header-img" />
              <h6>Field Values</h6>
              <a href="#" class="dropui-close"><img src="images/icons/52.png" /></a>
        ...
        <!-- end dropui-typo-field-text -->

        <div id="dropui-border-form" class="dropui dropui-teal dropui-circle dropui-right et-prop-border"> <img src="images/arrows/arrow_right_teal.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">A</a>
          <div class="dropui-content" style="width: 270px">
            <div class="dropui-content-header"> <img src="images/icons/115.png" class="dropui-header-img" />
              <h6>Form Border</h6>
              <a href="#" class="dropui-close"><img src="images/icons/52.png" /></a>
              <div class="dropui-header-clear"></div>
            </div>
        ...
        <!-- end dropui-border-form -->

        <div id="dropui-border-guidelines" class="dropui dropui-teal dropui-circle dropui-right et-prop-border"> <img src="images/arrows/arrow_right_teal.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">B</a>
          <div class="dropui-content" style="width: 270px">
            <div class="dropui-content-header"> <img src="images/icons/115.png" class="dropui-header-img" />
        ...
        <!-- end dropui-border-guidelines -->

        <div id="dropui-border-section" class="dropui dropui-teal dropui-circle dropui-right et-prop-border"> <img src="images/arrows/arrow_bottom_right_teal.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">C</a>
          <div class="dropui-content" style="width: 270px">
            <div class="dropui-content-header"> <img src="images/icons/115.png" class="dropui-header-img" />
        ...
        <!-- end dropui-border-section -->

        <div id="dropui-form-shadow" class="dropui dropui-blue dropui-circle dropui-left et-prop-shadow"> <img src="images/arrows/arrow_left_curly_blue.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">A</a>
          <div class="dropui-content" style="width: 360px">
            <div class="dropui-content-header"> <img src="images/icons/117.png" class="dropui-header-img" />
              <h6>Form Shadow</h6>
              <a href="#" class="dropui-close"><img src="images/icons/52.png" /></a>
              <div class="dropui-header-clear"></div>
            </div>
        ...
        <!-- end dropui-form-shadow -->

        <div id="dropui-form-button" class="dropui dropui-red dropui-circle dropui-left et-prop-button"> <img src="images/arrows/arrow_left_red.png" class="dropui-arrow-img" /> <a href="javascript:;" class="dropui-tab dropui-prop">A</a>
          <div class="dropui-content" style="width: 500px">
            <div class="dropui-content-header"> <img src="images/icons/62.png" class="dropui-header-img" />
            ...
            <div class="dropui-content-main">
              <div style="float: left; width: 150px">
                <ul id="et_ul_form_button">
                  <li class="prop_selected">
                    <input type="radio" title="Use Text Button" name="et_form_button" id="et_form_button_text" />
                    <label for="et_form_button_text">Use Text Button</label>
                  </li>
                  <li>
                    <input type="radio" title="Use Image Button" name="et_form_button" id="et_form_button_image" />
                    <label for="et_form_button_image">Use Image Button</label>
                  </li>
                </ul>
              </div>
              <div id="et_form_button_content">
                <div id="et_form_button_text_tab"> <span style="display: block">
                ...
                <div id="et_form_button_image_tab" style="display: none"> <span style="display: block">
        ...
        <div id="dialog-theme-saved" title="Success!" class="buttons" style="display: none"> <img src="images/navigation/005499/50x50/Success.png" title="Success" />
          <p id="dialog-theme-saved-msg"> Your theme has been saved. </p>
        </div>
        ...
        <div id="dialog-delete-theme" title="Are you sure you want to delete this theme?" class="buttons" style="display: none">
          ...
          <p> This action cannot be undone.<br/>
            <strong>Any form using this theme will be reverted to the default theme.</strong><br/>
            <br/>
          </p>
        </div>
        <div id="dialog-share-theme" title="Are you sure you want to share this theme?" class="buttons" style="display: none"> <img src="images/navigation/005499/50x50/Notice.png" title="Confirmation" />
          <p> <br/>
            <strong>Any other users will be able to use this theme on their forms.</strong><br/>
            <br/>
            They won't be able to edit this theme, only using it.<br />
            <br />
          </p>
        </div>
        <div id="dialog-unshare-theme" title="Are you sure you want to set this theme private?" class="buttons" style="display: none">
          ...
          <p> This action might affect many forms.<br/>
            <strong>Any form using this theme will be reverted to the default theme.</strong><br/>
            <br/>
          </p>
        </div>
