 ...
 ********************************************************************************/	
	...
	$access_key = la_sanitize($_GET['key']);
	...
	if(!empty($row)){
		$row['form_name'] = la_trim_max_length($row['form_name'],35);
	...
	$form_properties = la_get_form_properties($dbh,$form_id,array('payment_enable_merchant','form_resume_enable'));
	...
	if($chart_type == 'grid'){
		$query = "select element_name from ".LA_TABLE_PREFIX."grid_columns where form_id=? and chart_id=?";
		$params = array($form_id,$chart_id);
  ...
  <div class="post edit_widget">
    ...
    <div class="content_body">
      <ul id="ew_main_list" style="margin-bottom: 25px" data-formid="<?php echo $form_id; ?>" data-charttype="<?php echo $chart_type; ?>" data-chartid="<?php echo $chart_id; ?>">
            ...
            <div class="ew_box_content"> 
              ...
              <select class="element select" id="ew_select_datasource" name="ew_select_datasource" style="display: none">
                <?php
												...
												$options_markup = la_get_chart_datasource_markup($dbh,$form_id,$params);
												echo $options_markup;
              ...
              <label class="description" for="ew_chart_enable_filter" style="margin-top: 20px"> Data Option <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="By default, the widget will be based on all entries data. You can enable filter to generate the widget based on specific set of data."/> </label>
              <select class="select small" id="ew_chart_enable_filter" autocomplete="off">
                <option <?php if(empty($chart_enable_filter) && ($chart_datasource != 'status_indicators')){ echo 'selected="selected"'; } ?> value="0">Use all entries</option>
                <option <?php if(!empty($chart_enable_filter) && ($chart_datasource != 'status_indicators')){ echo 'selected="selected"'; } ?> value="1">Filter entries</option>
								<option <?php if($chart_datasource == 'status_indicators'){ echo 'selected="selected"'; } ?> value="2">Status Indicators</option>
              </select>
              
              <!-- start widget filter pane -->
              <div id="widget_filter_pane" <?php if((empty($chart_enable_filter)) || ($chart_datasource == 'status_indicators')){ echo 'style="display: none"'; } ?>>
                <h6>Use entries that match
                  ...
                  of the following conditions: </h6>
                <ul>
                  <?php
                  ...
                  <li id="li_1" class="filter_settings <?php echo $filter_date_class; ?>">
                    ...
                    <span style="display:none"><img id="datepickimg_1" alt="Pick date." src="images/icons/calendar.png" class="trigger filter_date_trigger" style="vertical-align: top; cursor: pointer" /></span> <a href="#" id="deletefilter_1" class="filter_delete_a"><img src="images/icons/51_blue_16.png" /></a> </li>
                  <?php 
											} else { 
                  ...
                  <li id="li_<?php echo $i; ?>" class="filter_settings <?php echo $filter_date_class; ?>">
                    ...
                    <span style="display:none"><img id="datepickimg_<?php echo $i; ?>" alt="Pick date." src="images/icons/calendar.png" class="trigger filter_date_trigger" style="vertical-align: top; cursor: pointer" /></span> <a href="#" id="deletefilter_<?php echo $i; ?>" class="filter_delete_a"><img src="images/icons/51_blue_16.png" /></a> </li>
                  <?php 	
												$i++;
												}//end foreach filter_data
											} //end else
										?>
                  <li id="li_filter_add" class="filter_add" style="text-align: right"> <a href="#" id="filter_add_a"><img src="images/icons/49_blue_16.png" /></a> </li>
                </ul>
              </div>
        ...
        <li>
          <div id="ew_box_widget_options" class="ew_box_main gradient_blue">
            <div class="ew_box_meta">
              <h1>2.</h1>
            ...
            <div class="ew_box_content">
              <ul id="ew_widget_options_list">
                <li id="li_chart_theme" style="width: 162px; float: left">
                  <label class="description" for="ew_chart_theme" style="margin-top: 2px"> Theme <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Select the color scheme of your widget."/> </label>
                ...
                <li id="li_background_color" style="width: 160px; margin-left: 25px;float: left;display: <?php if($show_background_color_property){ echo 'block'; }else{ echo 'none'; } ?>">
                  <div class="minicolors_container" >
                    <label class="description" style="margin-top: 2px"> Background Color <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Leave this empty to use transparent background color (recommended)."/> </label>
                ...
                <li id="li_line_style" style="width: 162px; clear: both; padding-top: 10px; margin-top: 10px;display: <?php if($show_line_style_property){ echo 'block'; }else{ echo 'none'; } ?>">
                  <label class="description" for="ew_chart_line_style" style="margin-top: 2px"> Graph Line Style <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Select the line style of the graph."/> </label>
                ...
                <li id="li_show_title" style="clear: both;padding-top: 15px">
                  ...
                  <div id="ew_show_title_div" <?php if(empty($chart_title)){ echo 'style="display: none"'; } ?>>
                    ...
                    </span> <span style="display: block; float: right; width: 45%;">
                ...
                <li id="li_show_labels" style="padding-top: 5px;display: <?php if($show_labels_property){ echo 'block'; }else{ echo 'none'; } ?>">
                  ...
                  <div id="ew_show_labels_div" <?php if(empty($chart_labels_visible)){ echo 'style="display: none"'; } ?>>
                    ...
                    </span> <span id="ew_chart_labels_align_span" style="display: <?php if( ($chart_type == 'pie' || $chart_type == 'donut') && ($chart_labels_position == 'outsideEnd') ){ echo 'block'; }else{ echo 'none'; } ?>; float: right; width: 45%;">
                ...
                <li id="li_bar_color" style="width: 362px;padding-top: 10px; margin-top: 15px; border-top: 1px dashed #80b638;display: <?php if($show_bar_color_property){ echo 'block'; }else{ echo 'none'; } ?>">
                  <div class="minicolors_container" >
                    <label class="description" style="margin-top: 2px"> Bar Color <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Leave this empty to use default color provided by the widget theme."/> </label>
                    <input type="text" id="ew_chart_bar_color" name="ew_chart_bar_color" class="colors" style="vertical-align: middle"  size="7" value="" />
                  </div>
                </li>
                <li id="li_date_range" style="width: 362px;padding-top: 10px; margin-top: 15px; border-top: 1px dashed #80b638;display: <?php if($show_date_range_property){ echo 'block'; }else{ echo 'none'; } ?>">
                  <label class="description" for="ew_chart_date_range" style="margin-top: 2px"> Date Range <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Select the range of your entries submission date that your chart will be based on. If you have set any filter previously, this date range will be applied on top of that filter."/> </label>
                  ...
                  <div id="ew_show_date_range_period_div" <?php if($chart_date_range != 'period'){ echo 'style="display: none"'; } ?>> <span> &#8674; Use data from the last
                    ...
                    </span> <span style="margin-top: 10px"> &#8674; Display
                  ...
                  <div id="ew_show_date_range_custom_div" <?php if($chart_date_range != 'custom'){ echo 'style="display: none"'; } ?>>
                    <ul id="li_date_range_custom">
                      <li style="float: left; width: 45%">
                        ...
                        <span style="display:none"> <img id="datepickimg_chart_date_range_start" alt="Pick date." src="images/icons/calendar.png" class="trigger" style="vertical-align: top; cursor: pointer" /> </span> </li>
                      <li style="float: left; width: 45%">
                        ...
                        <span style="display:none"> <img id="datepickimg_chart_date_range_end" alt="Pick date." src="images/icons/calendar.png" class="trigger" style="vertical-align: top; cursor: pointer" /> </span> </li>
                      <li style="clear: both;padding-top: 15px"> &#8674; Display
                ...
                <li id="li_grid_page_size" style="width: 162px;margin-top:10px; float: left;display: <?php if($chart_type == 'grid'){ echo 'block'; }else{ echo 'none'; } ?>">
                  <label class="description" for="ew_grid_page_size" style="margin-top: 2px">Rows Per Page <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="The number of rows of data to appear on each page. Minimum value is 1."/> </label>
                ...
                <li id="li_grid_max_length" style="width: 160px;margin-top:10px;margin-left: 25px;float: left;display: <?php if($chart_type == 'grid'){ echo 'block'; }else{ echo 'none'; } ?>">
                  <label class="description" for="ew_grid_max_length" style="margin-top: 2px">Cell Max Length <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="The maximum number of characters can be displayed in each cell of the grid. Leave this empty or enter 0 to remove any limit (NOTE: This might cause your grid to load slower)."/> </label>
        ...
        <li class="ps_arrow"><img src="images/icons/33_red.png" /></li>
        <li>
          <div id="ew_box_widget_size" class="ew_box_main gradient_blue">
            <div class="ew_box_meta">
              <h1>3.</h1>
              <h6>Widget Size</h6>
            </div>
            <div class="ew_box_content">
              <label class="description" for="ew_chart_height" style="margin-top: 10px"> Widget Height <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="The width of your widget will be automatically calculated based on the height you set here and based on the width of the container where you embed the widget."/> </label>
        ...
        <li class="ps_arrow"><img src="images/icons/33_red.png" /></li>
        <li>
          <div style="width: 200px; margin: 0 auto"> <a href="#" id="button_save_widget" class="bb_button bb_small bb_green"><img src="images/navigation/FFFFFF/24x24/Save.png"> Save Settings </a> </div>
        </li>
      </ul>
    </div>
    <!-- /end of content_body --> 
