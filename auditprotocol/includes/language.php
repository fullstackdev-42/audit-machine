 ...
 ********************************************************************************/
	...
	$la_lang['name_first']			=	'First';
	$la_lang['name_middle']			=	'Middle';
	$la_lang['name_last']			=	'Last';
	$la_lang['name_title']			=	'Title';
	$la_lang['name_suffix']			=	'Suffix';
	
	//address
	$la_lang['address_street']		=	'Street Address';
	$la_lang['address_street2']		=	'Address Line 2';
	$la_lang['address_city']		=	'City';
	$la_lang['address_state']		=	'State / Province / Region';
	$la_lang['address_zip']			=	'Postal / Zip Code';
	$la_lang['address_country']		=	'Country';

	//captcha
	$la_lang['captcha_required']			=	'This field is required. please verify that you are human..';
	$la_lang['captcha_text_mismatch'] 		=	'Incorrect answer. Please try again.';
	$la_lang['captcha_error']				=	'Error while processing, please try again.';
	$la_lang['captcha_simple_image_title']	= 	'Type the letters you see in the image below.';
	$la_lang['captcha_simple_text_title']	= 	'Spam Protection. Please answer this simple question.';
	
	//date
	$la_lang['date_dd']				=	'DD';
	$la_lang['date_mm']				=	'MM';
	$la_lang['date_yyyy']			=	'YYYY';
	
	//price
	$la_lang['price_dollar_main']	=	'Dollars';
	$la_lang['price_dollar_sub']	=	'Cents';
	$la_lang['price_euro_main']		=	'Euros';
	$la_lang['price_euro_sub']		=	'Cents';
	$la_lang['price_pound_main']	=	'Pounds';
	$la_lang['price_pound_sub']		=	'Pence';
	$la_lang['price_yen']			=	'Yen';
	$la_lang['price_baht_main']		=	'Baht';
	$la_lang['price_baht_sub']		=	'Satang';
	$la_lang['price_rupees_main']	=	'Rupees';
	$la_lang['price_rupees_sub']	=	'Paise';
	$la_lang['price_rand_main']		=	'Rand';
	$la_lang['price_rand_sub']		=	'Cents';
	$la_lang['price_forint_main']	=	'Forint';
	$la_lang['price_forint_sub']	=	'Filler';
	$la_lang['price_franc_main']	=	'Francs';
	$la_lang['price_franc_sub']		=	'Rappen';
	$la_lang['price_koruna_main']	=	'Koruna';
	$la_lang['price_koruna_sub']	=	'Haléřů';
	$la_lang['price_krona_main']	=	'Kroner';
	$la_lang['price_krona_sub']		=	'Øre';
	$la_lang['price_pesos_main']	=	'Pesos';
	$la_lang['price_pesos_sub']		=	'Cents';
	$la_lang['price_ringgit_main']	=	'Ringgit';
	$la_lang['price_ringgit_sub']	=	'Sen';
	$la_lang['price_zloty_main']	=	'Złoty';
	$la_lang['price_zloty_sub']		=	'Grosz';
	$la_lang['price_riyals_main']	=	'Riyals';
	$la_lang['price_riyals_sub']	=	'Halalah';
        $la_lang['price_dirham']    =       'AED';
	...
	//error message
	$la_lang['error_title']			=	'There was a problem with your submission.';
	$la_lang['error_desc']			=	'Errors have been <strong>highlighted</strong> below.';
	
	//form buttons
	$la_lang['submit_button']		=	'Submit';
	$la_lang['continue_button']		=	'Continue';
	$la_lang['back_button']			=	'Previous';
	
	//form status
	$la_lang['form_inactive']		=	'This form is currently inactive.';
	$la_lang['form_limited']		=   'Sorry, but this form is no longer accepting any entries.';
	
	//form password
	$la_lang['form_pass_title']		=	'This form is password protected.';
	$la_lang['form_pass_desc']		=	'Please enter your password.';
	$la_lang['form_pass_invalid']	=	'Invalid Password!';
	
	//form review
	$la_lang['review_title']		=	'Review Your Entry';
	$la_lang['review_message']		=	'Please review your entry below. Click Submit button to finish.';
	
	//validation message 
	$la_lang['val_required'] 		=	'This field is required. Please enter a value.';
	$la_lang['val_required_file'] 	=	'This field is required. Please upload a file.';
	$la_lang['val_unique'] 			=	'This field requires a unique entry and this value has already been used.';
	$la_lang['val_integer'] 		=	'This field must be an integer.';
	$la_lang['val_float'] 			=	'This field must be a float.';
	$la_lang['val_numeric'] 		=	'This field must be a number.';
	$la_lang['val_email'] 			=	'This field is not in the correct email format.';
	$la_lang['val_website'] 		=	'This field is not in the correct website address format.';
	$la_lang['val_username'] 		=	'This field may only consist of a-z 0-9 and underscores.';
	$la_lang['val_equal'] 			=	'%s must match.';
	$la_lang['val_date'] 			=	'This field is not in the correct date format.';
	$la_lang['val_date_range'] 		=	'This date field must be between %s and %s.';
	$la_lang['val_date_min'] 		=	'This date field must be greater than or equal to %s.';
	$la_lang['val_date_max'] 		=	'This date field must be less than or equal to %s.';
	$la_lang['val_date_na'] 		=	'This date is not available for selection.';
	$la_lang['val_time'] 			=	'This field is not in the correct time format.';
	$la_lang['val_phone'] 			=	'Please enter a valid phone number.';
	$la_lang['val_inter_phone']     =	'Please enter a valid phone number. Recommended format: +1-888-896-6207';
	$la_lang['val_filetype']		=	'The filetype you are attempting to upload is not allowed.';
	
	//fields on excel/csv
	$la_lang['export_num']			=	'No.';
	$la_lang['date_created']		=	'Date Created';
	$la_lang['date_updated']		=	'Date Updated';
	$la_lang['ip_address']			=	'IP Address';

	//form resume
	$la_lang['resume_email_subject']		= 'Your submission to %s has been saved';
	$la_lang['resume_email_content'] 		= 'Thank you! Your submission to <b>%s</b> has been saved.<br /><br />You can resume the form at any time by clicking the link below:<br /><a href="%s">%s</a><br /><br /><br /><br /><b>IMPORTANT:</b><br />Your submission is considered incomplete until you resume the form and press the submit button.';							

	$la_lang['resume_success_title']   		= 'Your progress has been saved.';
	$la_lang['resume_success_content'] 		= 'Please copy the link below and save it in a safe place:<br/>%s<br/><br/>You can resume the form at any time by going to the above link.';

	$la_lang['resume_checkbox_title']		= 'Save my progress and resume later';
	$la_lang['resume_email_input_label']	= 'Enter Your Email Address';
	$la_lang['resume_submit_button_text']	= 'Save form and resume later';
	$la_lang['resume_guideline']			= 'A special link to resume the form will be sent to your email address.';

	//range validation
	$la_lang['range_type_digit']			= 'digits';
	$la_lang['range_type_chars'] 			= 'characters';
	$la_lang['range_type_words'] 			= 'words';

	$la_lang['range_min']  					= 'Minimum of %s required.'; 
	$la_lang['range_min_entered']   		= 'Currently Entered: %s.';

	$la_lang['range_max']					= 'Maximum of %s allowed.';
	$la_lang['range_max_entered']   		= 'Currently Entered: %s.';

	$la_lang['range_min_max'] 				= 'Must be between %s and %s.';
	$la_lang['range_min_max_same'] 			= 'Must be %s.';
	$la_lang['range_min_max_entered'] 		= 'Currently Entered: %s.';

	$la_lang['range_number_min']	 		= 'Must be a number greater than or equal to %s.';
	$la_lang['range_number_max']	 		= 'Must be a number less than or equal to %s.';
	$la_lang['range_number_min_max'] 		= 'Must be a number between %s and %s';

	//file uploads
	$la_lang['file_queue_limited'] 			= 'This field is limited to maximum %s files.';
	$la_lang['file_upload_max']	   			= 'Error. Maximum %sMB allowed.';
	$la_lang['file_type_limited']  			= 'Error. This file type is not allowed.';
	$la_lang['file_error_upload']  			= 'Error! Unable to upload';
	$la_lang['file_attach']		  			= 'Attach Files';

	//payment page
	$la_lang['payment_total'] 				= 'Total';
	$la_lang['form_payment_header_title'] 	= 'Payment';
	$la_lang['form_payment_title'] 			= 'Enter Payment Information';
	$la_lang['form_payment_description'] 	= 'Please review the details below before entering payment information.';
	$la_lang['payment_submit_button']		= 'Submit Payment';
	$la_lang['tax']							= 'Tax';

	//payment details
	$la_lang['payment_status']	 = 'Status';
	$la_lang['payment_id']		 = 'Payment ID';
	$la_lang['payment_date']	 = 'Payment Date';
	$la_lang['payment_fullname'] = 'Full Name';
	$la_lang['payment_shipping'] = 'Shipping Address';
	$la_lang['payment_billing']	 = 'Billing Address';	

	//multipage
	$la_lang['page_title']					= 'Page %s of %s';

	//coupon code
	$la_lang['coupon_not_exist'] = "This coupon code does not exist.";
	$la_lang['coupon_max_usage'] = "This coupon has reached the maximum redemption limit.";
	$la_lang['coupon_expired']	 = "This coupon code has been expired.";
	$la_lang['discount']		 = 'Discount';

	/** Functions **/

	//this function set the global language variable ($la_language) to the selected language
	function la_set_language($target_language){
		global $la_lang;
		...
		if($target_language == 'english'){
			...
			//captcha
			$languages['captcha_required']				= 'This field is required. please verify that you are human..';
			...
			$languages['val_inter_phone']     	=	'Please enter a valid phone number. Recommended format: +1-888-896-6207';
			...
			$languages['page_title']	   = 'Halaman %s dari %s';
                        ...
                        //simple name and extended name
                        $languages['name_first']                        = 'اسم';
                        $languages['name_middle']                       = 'الاسم الأوسط';
                        $languages['name_last']                         = 'اسم العائلة';
                        $languages['name_title']                        = 'عنوان';
                        $languages['name_suffix']                       = 'عنوان';

                        //address
                        $languages['address_street']            = 'شارع';
                        $languages['address_street2']           = 'خط العنوان الإضافي';
                        $languages['address_city']                      = 'مدينة';
                        $languages['address_state']                     = 'الدولة / المقاطعة / المنطقة';
                        $languages['address_zip']                       = 'الرمز البريدي';
                        $languages['address_country']           = 'بلد';

                        //captcha
                        $languages['captcha_required']                          = 'هذه الخانة مطلوبه. يرجى إدخال الحروف الموضحة في الصورة.';
                        $languages['captcha_mismatch']                          = 'الحروف الموجودة في الصورة غير متطابقة. حاول ثانية.';
                        $languages['captcha_text_mismatch']             = 'إجابة خاطئة. حاول مرة اخرى.';
                        $languages['captcha_error']                                     = 'خطأ في المعالجة ، يرجى المحاولة مرة أخرى.';
                        $languages['captcha_simple_image_title']        = 'أدخل الحروف التي تراها في الصورة أدناه.';
                        $languages['captcha_simple_text_title']         = 'الحماية من البريد المزعج. يرجى الإجابة على هذا السؤال البسيط.';
                        ...
                        $languages['price_franc_sub']		=	'Rappen';
                        $languages['price_koruna_main']		=	'Koruna';
                        $languages['price_koruna_sub']		=	'HalÃ©Å™Å¯';
                        $languages['price_krona_main']		=	'Kroner';
                        $languages['price_krona_sub']		=	'Ã˜re';
                        $languages['price_pesos_main']		=	'Pesos';
                        $languages['price_pesos_sub']		=	'Cents';
                        $languages['price_ringgit_main']	=	'Ringgit';
                        $languages['price_ringgit_sub']		=	'Sen';
                        $languages['price_zloty_main']		=	'ZÅ‚oty';
                        $languages['price_zloty_sub']		=	'Grosz';
                        $languages['price_riyals_main']		=	'Riyals';
                        $languages['price_riyals_sub']		=	'Halalah';
                        $languages['price_dirham']		=	'AED';
                        ...
                        //time
                        $languages['time_hh']                           =       'ح ح';
                        $languages['time_mm']                           =       'MM';
                        $languages['time_ss']                           =       'СС';

                        //error message
                        $languages['error_title']                       =       'كانت هناك مشكلة في تقديم المعلومات.';
                        $languages['error_desc']                        =       'الأخطاء مذكورة أدناه.';

                        //form buttons
                        $languages['submit_button']                     =       'تسليم';
                        $languages['continue_button']           =       'استمر امضي قدما';
                        $languages['back_button']                       =       'سابقا';

                        //form status
                        $languages['form_inactive']                     =       'هذا النموذج غير نشط حاليًا.';
                        $languages['form_limited']                      =   'عذرا ، لكن هذا الشكل لم يعد يقبل المعلومات.';

                        //form password
                        $languages['form_pass_title']           =       'هذا النموذج محمي بكلمة مرور.';
                        $languages['form_pass_desc']            =       'من فضلك أدخل رقمك السري.';
                        $languages['form_pass_invalid']         =       'رمز مرور خاطئ!';

                        //form review
                        $languages['review_title']                      =       'مراجعة المعلومات المدخلة';
                        $languages['review_message']            =       'يرجى مراجعة المعلومات الواردة أدناه. انقر فوق الزر "إرسال" للانتهاء.';

                        //validation message
                        $languages['val_required']                      =       'هذه الخانة مطلوبه. ادخل قيمه من فضلك.';
                        $languages['val_required_file']         =       'هذه الخانة مطلوبه. يرجى تحميل ملف.';
                        $languages['val_unique']                        =       'يتطلب هذا الحقل قيمة إدخال فريدة وقد تم استخدام هذه القيمة بالفعل.';
                        $languages['val_integer']                       =       'يجب أن يكون هذا الحقل عددًا صحيحًا.';
                        $languages['val_float']                         =       'يجب أن يكون هذا الحقل نقطة عائمة.';
                        $languages['val_numeric']                       =       'يجب أن يكون هذا الحقل رقمًا.';
                        $languages['val_email']                         =       'هذا الحقل ليس بتنسيق البريد الإلكتروني الصحيح.';
                        $languages['val_website']                       =       'هذا الحقل ليس بالتنسيق الصحيح لعنوان موقع الويب.';
                        $languages['val_username']                      =       'يمكن أن يتكون هذا الحقل فقط من a-z 0-9 وخصائص أقل.';
                        $languages['val_equal']                         =       'يجب أن تطابق٪ s.';
                        $languages['val_date']                          =       'هذا الحقل ليس بتنسيق التاريخ الصحيح.';
                        $languages['val_date_range']            =       'يجب أن يكون مربع التاريخ هذا بين٪ s و٪ s.';
                        $languages['val_date_min']                      =       'يجب أن يكون مربع التاريخ هذا أكبر من أو يساوي٪ s.';
                        $languages['val_date_max']                      =       'Тيجب أن يكون حقل التاريخ أقل من أو يساوي٪ s.';
                        $languages['val_date_na']                       =       'هذا التاريخ غير متاح للاختيار.';
                        $languages['val_time']                          =       'هذا الحقل ليس بتنسيق الوقت الصحيح.';
                        $languages['val_phone']                         =       'يرجى إدخال رقم هاتف صالح.';
                        $languages['val_filetype']                      =       'غير مسموح بنوع الملف الذي تحاول تحميله.';

                        //fields on excel/csv
                        $languages['export_num']                        =       'لا';
                        $languages['date_created']                      =       'تاريخ الخلق';
                        $languages['date_updated']                      =       'تاريخ التحديث';
                        $languages['ip_address']                        =       'عنوان IP';

                        //form resume
                        $languages['resume_email_subject']              = 'تم حفظ المعلومات التي قدمتها في النموذج٪ s';
                        $languages['resume_email_content']              = 'شكرا لكم! تم حفظ المعلومات التي قدمتها. يمكنك استئناف النموذج في أي وقت من خلال النقر على الرابط أدناه. هام: يعتبر إرسالك غير مكتمل إلى أن تستأنف النموذج مرة أخرى ولا تضغط على الزر "إرسال".';                       

                        $languages['resume_success_title']      = 'المعلومات المسجلة حتى الآن تم تسجيلها.';
                        $languages['resume_success_content']    = 'يرجى نسخ الرابط أدناه وحفظه في مكان آمن. يمكنك استئناف النموذج في أي وقت من خلال النقر على الرابط أعلاه.';

                        $languages['resume_checkbox_title']             = 'سجل المعلومات المدخلة والمتابعة لاحقًا';
                        $languages['resume_email_input_label']  = 'أدخل عنوان بريدك الالكتروني';
                        $languages['resume_submit_button_text'] = 'احفظ النموذج والمتابعة لاحقًا';
                        $languages['resume_guideline']                  = 'سيتم إرسال رابط خاص لمتابعة النموذج إلى عنوان بريدك الإلكتروني.';

                        //range validation
                        $languages['range_type_digit']                  = 'الأرقام';
                        $languages['range_type_chars']                  = 'حرف';
                        $languages['range_type_words']                  = 'كلمات';

                        $languages['range_min']                                 = 'مطلوب على الأقل٪ s.';
                        $languages['range_min_entered']                 = 'نحن ندخل حاليًا:٪ s.';

                        $languages['range_max']                                 = 'نحن ندخل حاليًا:٪ s.';
                        $languages['range_max_entered']                 = 'نحن ندخل حاليًا:٪ s.';

                        $languages['range_min_max']                     = 'يجب أن يكون بين٪ s و٪ s.';
                        $languages['range_min_max_same']                = 'يجب أن يكون٪ s.';
                        $languages['range_min_max_entered']     = 'نحن ندخل حاليًا:٪ s.';

                        $languages['range_number_min']                  = 'يجب أن يكون الرقم أكبر من أو يساوي٪ s.';
                        $languages['range_number_max']                  = '"يجب أن يكون الرقم أقل من أو يساوي٪ s.';
                        $languages['range_number_min_max']              = 'يجب أن يكون رقمًا بين٪ s و٪ s';

                        //file uploads
                        $languages['file_queue_limited']                = 'يقتصر هذا الحقل على الحد الأقصى لملف٪ s.';
                        $languages['file_upload_max']                   = 'خطأ. ما يصل إلى حد أقصى من٪ sMB مسموح به.';
                        $languages['file_type_limited']                 = 'خطأ. هذا النوع من الملفات غير مسموح به.';
                        $languages['file_error_upload']                 = 'خطأ! لا يمكن تحميل الملف';
                        $languages['file_attach']                               = 'إرفاق ملفات';

                        //payment total
                        $languages['payment_total']                     = 'مجموع';
                        $languages['form_payment_header_title'] = 'دفع';
                        $languages['form_payment_title']                = 'إدخال معلومات الدفع';
                        $languages['form_payment_description']  = 'يرجى مراجعة التفاصيل أدناه قبل إدخال معلومات الدفع.';
                        $languages['payment_submit_button']             = 'إرسال الدفع';
                        $languages['tax']                                               = 'ضريبة';

                        //payment details
                        $languages['payment_status']    = 'الحالة';
                        $languages['payment_id']                = 'معرف الدفع';
                        $languages['payment_date']              = 'تاريخ الدفع';
                        $languages['payment_fullname']  = 'الاسم الكامل';
                        $languages['payment_shipping']  = 'عنوان الشحن';
                        $languages['payment_billing']   = 'عنوان وصول الفواتير';

                        //coupon code
                        $languages['coupon_not_exist'] = "رمز القسيمة هذا غير موجود.";
                        $languages['coupon_max_usage'] = "وصلت هذه القسيمة إلى الحد الأقصى لاسترداد القيمة.";
                        $languages['coupon_expired']   = "لقد انتهت صلاحية شفرة القسيمة هذه.";
                        $languages['discount']             = "خصم";

                        //multipage
                        $languages['page_title']                                = 'صفحة٪ s من٪ s';
		}
