 ...
 ********************************************************************************/	
	...
	if(la_is_form_submitted()){ //if form submitted
		...
		$query = "select ifnull(max(`chart_id`),0) + 1 as new_chart_id from ".LA_TABLE_PREFIX."report_elements where form_id = ?";
		$params = array($form_id);
		...
		la_do_query($query,$widget_params,$dbh);
			
		//redirect to manage_report page and display success message
		$_SESSION['LA_SUCCESS'] = 'A new widget has been added.';

		$ssl_suffix = la_get_ssl_suffix();						
		header("Location: manage_report.php?id={$form_id}");
		exit;
...
<div id="content" class="full">
  <div class="post add_widget">
    <div class="content_header">
      <div class="content_header_title">
        <div style="float: left">
          <h2><?php echo "<a class=\"breadcrumb\" href='manage_forms.php?id={$form_id}'>".$form_name.'</a>'; ?> <img src="images/icons/resultset_next.gif" /> <?php echo "<a class=\"breadcrumb\" href='manage_report.php?id={$form_id}'>Micro Report</a>"; ?> <img src="images/icons/resultset_next.gif" /> Add Micro Report</h2>
    ...
    <div class="content_body">
      <form id="add_widget_form" method="post" action="<?php echo noHTML($_SERVER['PHP_SELF']); ?>">
        ...
        <ul id="aw_main_list">
          <li>
            <div id="aw_box_select_widget" class="aw_box_main gradient_blue">
              ...
              <div class="aw_box_content" style="padding-bottom: 15px">
                <label class="description" for="aw_select_widget" style="margin-top: 10px"> Select Micro Report Type </label>
                ...
                <div class="grid-wrapper" style="margin-top: 20px;display: none"> <img src="images/grid-preview.png" width="488" height="226" style="border-radius: 10px"/> </div>
          ...
          <li>
            <div id="aw_box_widget_settings" class="aw_box_main gradient_blue">
              <div class="aw_box_meta">
                <h1 id="widget_setting_header">2.</h1>
                <h6>Report Title</h6>
              </div>
              <div class="aw_box_content" style="min-height: 90px"> <span style="display: block">
                <label class="description" for="aw_widget_title" style="margin-top: 10px">Title</label>
                <input id="aw_widget_title" name="aw_widget_title" class="element text" style="width: 90%" value="" type="text">
                </span> <span id="aw_horizontal_axis_span" style="display: none; margin-bottom: 10px">
                <label class="description" for="aw_horizontal_axis" style="margin-top: 10px"> Horizontal Axis </label>
          ...
          <li class="ps_arrow select_datasource_group"><img src="images/icons/33_red.png" /></li>
          <li class="select_datasource_group">
            <div id="aw_box_select_field" class="aw_box_main gradient_blue">
              <div class="aw_box_meta">
                <h1>3.</h1>
                <h6>Select Field</h6>
              </div>
              <div class="aw_box_content" style="min-height: 90px;">
                <?php
					...
					$options_markup_simple = la_get_chart_datasource_markup($dbh,$form_id,$params);

					$params = array();
					$params['show_expanded_options'] = true;
					$options_markup_expanded = la_get_chart_datasource_markup($dbh,$form_id,$params);
				?>
                ...
                <select class="element select" id="aw_select_datasource_lookup" name="aw_select_datasource_lookup" style="display: none">
								<option value="status_indicators">Status Indicators</option>
                ...
                <?php } ?>
                </span> <span id="select_datasource_span_expanded" style="display: none">
                <?php
                ...
                <?php } ?>
                </span> <span id="select_datasource_span_allfield" style="display: none">
                <label class="description" style="margin-top: 10px;margin-bottom: 30px">All fields will be displayed. <br/>
                  <br/>
                  You will be able to select individual fields after you create your widget.</label>
                </span>
                <p id="aw_select_field_info"><img  src="images/icons/70_red2.png" style="vertical-align: top" /> Select the form field you want the micro report to be based on.</p>
              </div>
            </div>
          </li>
          <li class="ps_arrow add_widget_group"><img src="images/icons/33_red.png" /></li>
          <li class="add_widget_group">
            <div> <a href="#" id="button_add_widget" class="bb_button bb_small bb_green"> <span class="icon-disk" style="margin-right: 5px"></span>Add Micro Report </a> </div>
          </li>
        </ul>
        <input type="hidden" name="submit_form" value="1" />
        <input type="hidden" name="id" value="<?php echo noHTML($form_id); ?>" />
      </form>
    </div>
    <!-- /end of content_body --> 
...
?>
<script src="js/kendoui/js/kendo.custom.min.js" type="text/javascript"></script> 
<script src="js/add_widget.js" type="text/javascript"></script>