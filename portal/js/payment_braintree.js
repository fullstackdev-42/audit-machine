...
function la_submit_payment(){
    ...
    var payment_data = {
    					...
    					card_number: la_braintree.encrypt(la_number),
    					card_cvc: la_braintree.encrypt(la_cvc),
    					card_exp_month: la_braintree.encrypt(la_exp_month),
    					card_exp_year: la_braintree.encrypt(la_exp_year),
	...
	$.ajax({
			type: "POST",
			async: true,
			url: $("#main_body").data("itauditmachinepath") + "payment_submit_braintree.php",
			data: {
					form_id: $("#form_id").val(),
