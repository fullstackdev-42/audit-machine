...
function load_properties(o) {
    ...
    $("#element_custom_css").show();
	$('#prop_machine_code').show();
	$('#element_machine_code').val(u.machine_code);
	//$('#prop_machine_code').show();
    if (u.type == "text") {
                                                                    ...
                                                                    if (u.type == "matrix") {
                                                                        ...
                                                                        $.each(b, function(v, w) {
                                                                            if (v > 0) {
                                                                                ...
                                                                                j = '<li><input type="text" value="' + g.replace(/\"/g, "&quot;") + '" autocomplete="off" class="text" id="matrixrow_' + choice_element_id + '" /> <img class="add_choice" title="Add" alt="Add" src="images/icons/add.png" style="vertical-align: middle" id="matrixrowadd_' + choice_element_id + '">' + l + "</li>";
                                                                                e += j
                                                                            }
                                                                        });
...
function reorganize_page_break() {
    ...
    var h = '<li class="no_fields_in_page" title="Drag the button on the right side here to add new field."><span style="float: none;font-family: itauditmachine;margin-bottom: 20px;color: #529214;font-size: 50px;display: block" class="icon-arrow-right"></span><h3>This page has no fields!</h3><p><span style="color: #529214; font-weight: bold; float: none">Drag the button</span> on the right sidebar here to add new field.</p></li>';
...
$(function() {
    ...
    $("#bottom_bar_save_form").click(function() {
        if ($("#form_builder_sortable > li.no_fields_in_page").length > 0) {
            $("#ui-dialog-title-dialog-warning").html("Unable to save. Your form contains empty pages!");
	...
	/* $("#element_machine_code").bind("change", function() {
    ...
    $("#element_choices").delegate("input.text", "keyup", function(p) {
        ...
        if (p.keyCode == 13) {
            ...
            var c = '<li><input type="' + m + '" title="Select this choice as the default." class="choices_default" name="choices_default" id="choicedef_' + k + '" /><input type="text" value="" autocomplete="off" class="text" id="choice_' + k + '" /> <img class="add_choice" title="Add" alt="Add" src="images/icons/add.png" style="vertical-align: middle" id="choiceadd_' + k + '" ><img class="del_choice" title="Delete" alt="Delete" src="images/icons/delete.png" style="vertical-align: middle" id="choicedel_' + k + '" ></li>';
            n.parent().after(c);
	...
	/*$("#element_machine_code").bind("change", function() {
        alert(set_properties("element_machine_code", $(this).val()))
    });*/
