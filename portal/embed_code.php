		...
		<div id="content" class="full">
			<div class="post embed_code">
				...
				<div class="content_body">
					...
					<div id="ec_meta">
						<div id="ec_information" class="gradient_blue">
							<img style="vertical-align: top" src="images/navigation/005499/16x16/Help.png" class="helpmsg">
							...
							<span id="ec_info_php_file" style="display:none">This file will display your form without using any iframe. The file must be uploaded into the same server as your itauditmachine installation.</span>
