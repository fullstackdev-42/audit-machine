			...
			<div class="post manage_users">
				...
				<div class="content_body">
						...
						<?php 
							...
							echo la_display_users_table($dbh,$entries_options); 
						?>

						<?php if($la_settings['license_key'][0] == 'S' || $la_settings['license_key'][0] == 'P'){ ?>
						<div id="me_pagination_label">
							You have <strong style="color: #80b638"><?php echo $total_user_left; ?> users</strong> left. &nbsp;&nbsp;<a href="http://lazarusalliance.comupgrade-license?current=<?php echo strtolower($la_settings['license_key'][0]); ?>" class="breadcrumb" target="_blank">Upgrade License</a> to add more users.
						</div>
						<?php } ?>	
...
<div id="dialog-confirm-user-suspend" title="Are you sure you want to suspend selected users?" class="buttons" style="display: none">
	...
	<p id="dialog-confirm-user-suspend-msg">
		...
		<strong id="dialog-confirm-user-suspend-info">The user will be suspended and no longer has access to IT Audit Machine.</strong><br/><br/>
