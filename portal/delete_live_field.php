 ...
 ********************************************************************************/
	...
	$query = "select count(*) total_row from `".LA_TABLE_PREFIX."form_{$form_id}` where `status`=1";
	$params = array($form_id,$element_id);
	...
	if(LA_CONF_TRUE_DELETE == true || $table_is_empty === true){
		...
		if('address' == $element_type){
			$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$element_id}_1`,DROP COLUMN `element_{$element_id}_2`, DROP COLUMN `element_{$element_id}_3`, DROP COLUMN `element_{$element_id}_4`, DROP COLUMN `element_{$element_id}_5`, DROP COLUMN `element_{$element_id}_6`;";
			la_do_query($query,$params,$dbh);
			
		}elseif ('simple_name' == $element_type){
			$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$element_id}_1`,DROP COLUMN `element_{$element_id}_2`;";
			la_do_query($query,$params,$dbh);
			
		}elseif ('simple_name_wmiddle' == $element_type){
			$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$element_id}_1`,DROP COLUMN `element_{$element_id}_2`,DROP COLUMN `element_{$element_id}_3`;";
			la_do_query($query,$params,$dbh);
			
		}elseif ('name' == $element_type){
			$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$element_id}_1`,DROP COLUMN `element_{$element_id}_2`, DROP COLUMN `element_{$element_id}_3`, DROP COLUMN `element_{$element_id}_4`;";
			la_do_query($query,$params,$dbh);
			
		}elseif ('name_wmiddle' == $element_type){
			$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$element_id}_1`,DROP COLUMN `element_{$element_id}_2`, DROP COLUMN `element_{$element_id}_3`, DROP COLUMN `element_{$element_id}_4`, DROP COLUMN `element_{$element_id}_5`;";
			la_do_query($query,$params,$dbh);
			...
			if(!empty($element_choice_has_other)){
				$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$element_id}_other`";
				$params = array();
				la_do_query($query,$params,$dbh);
			}
			
		}elseif('radio' == $element_type){
			$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$element_id}`;";
			la_do_query($query,$params,$dbh);
			...
			if($matrix_allow_multiselect){ //if this is checkbox matrix
				...
				foreach ($matrix_rows_ids as $m_element_id){
						//delete each option from the form table
						$query = "ALTER TABLE `".LA_TABLE_PREFIX."form_{$form_id}` DROP COLUMN `element_{$m_element_id}`";
			...
			$query = "select element_{$element_id} from `".LA_TABLE_PREFIX."form_{$form_id}`";
			$sth = la_do_query($query,$params,$dbh);
			while($row = la_do_fetch_result($sth)){
