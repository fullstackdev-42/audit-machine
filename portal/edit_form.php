 ...
 ********************************************************************************/
	...
	if(empty($form_id)){
		...
		if($is_form_locked === true && empty($unlock_hash)){
			...
			header("Location: form_locked.php?id=".$form_id);
				...
				<form style="display: block;" id="element_properties" action="" onsubmit="return false;">
					...
					<div id="element_properties_form">
						...
						<li class="leftCol" id="prop_element_type">
							...
							<option value="policymachine_code">Policy Machine Code</option>
						...
						<li class="clear" id="prop_policymachine_code">
							...
							<label class="desc" for="element_policymachine_code">

							Custom Policy Machine Code

							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="This is advanced Policy Mahine option. You can add a custom Policy Machine variable to the parent element of the field. This is useful if you would like to generate Policy Machine reports using IT Audit Machine form data. These custom Policy Machine codes will not appear live in the form builder, only on the live form."/>
						...
						<li class="clear" id="element_custom_css">
                        ...
                        <!-- <div style="margin:10px 0 0;"><div style="clear: both"></div>
							...
							<input id="element_machine_code" class="text large" name="element_machine_code" value="" maxlength="255" type="text"></div>-->

						</li>

                     <li id="prop_machine_code">

							<label class="desc" for="element_machine_code">

							Policy Machine Code

							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="This is advanced Policy Machine option. You can add a custom Policy Machine variable to the parent element of the field. This is useful if you would like to generate Policy Machine reports using IT Audit Machine form data. These custom Policy Machine codes will not appear live in the form builder, only on the live form."/>

							</label>

							

							<input id="element_machine_code" class="text large" name="element_machine_code" value="" maxlength="255" type="text"></li>
								...
								<legend>Protection &amp; Limit</legend>
									...
									<span>	
										...
										<div id="form_password" style="display: none">
											...
											<img src="images/navigation/005499/16x16/My_account.png" alt="Password : " style="vertical-align: middle">
