 ...
 ********************************************************************************/	
	...
	$query = "select element_id,option_id from ".LA_TABLE_PREFIX."element_options where form_id = ? and live = 0";
	$params = array($form_id);
	...
	foreach ($deleted_element_options as $value) {
		$query = "delete from ".LA_TABLE_PREFIX."element_prices where form_id=? and element_id=? and option_id=?";
	...
	$query = "SELECT 
			    ...
			    FROM (
						SELECT 
							  ...
							  B.price 
						  FROM 
							  ".LA_TABLE_PREFIX."element_options A left join ".LA_TABLE_PREFIX."element_prices B 
							ON 
	...
	$query = "select element_id from ".LA_TABLE_PREFIX."element_prices where form_id = ? group by element_id asc";
	$params = array($form_id);
	...
	$query = "select 
					...
					B.`position` 
				from 
					".LA_TABLE_PREFIX."element_prices A left join ".LA_TABLE_PREFIX."element_options B 
				  on 
				  	(A.form_id=B.form_id and A.element_id=B.element_id and A.option_id=B.option_id) 
   			   where 
   			   		A.form_id = ? 
							...
							<div id="ps_box_merchant_settings" class="ps_box_main gradient_blue">
								...
								<div class="ps_box_content">
									<span>	
										...
										<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Disabling this option will turn off the payment functionality of your form."/>
									</span>
									
									<label class="description" for="ps_select_merchant" style="margin-top: 10px">
										Select a Merchant 
										<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="A merchant will process transactions on your form and authorize the payments."/>
									</label>
									...
									<div id="ps_paypal_options" class="merchant_options" <?php if($payment_properties->merchant_type != 'paypal_standard'){ echo 'style="display: none"'; } ?>>
										<label class="description" for="ps_paypal_email">PayPal Email Address <span class="required">*</span> <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="This is the email address associated with your PayPal account."/></label>
										...
										<label class="description" for="ps_paypal_language">Language <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Select the language to be displayed on PayPal pages."/></label>
										...
										<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top; margin-top: 12px" title="If enabled, all transactions will go through PayPal test server (Sandbox). You can use this to test payments without using actual money. You'll need to login to https://developer.paypal.com and create your sandbox account there."/>				
									</div>
									...
									<div id="ps_braintree_options" class="merchant_options" <?php if($payment_properties->merchant_type != 'braintree'){ echo 'style="display: none"'; } ?>>
										<div id="ps_braintree_live_keys" <?php if(!empty($payment_properties->braintree_enable_test_mode)){ echo 'style="display: none;"'; } ?>>
											<label class="description" for="ps_braintree_live_merchant_id">Merchant ID <span class="required">*</span> <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="These are API keys provided by Braintree. You can see all your keys in your Braintree control panel. Login to your Braintree account and go to 'Your Username' -> 'My User' -> 'API Keys'. Copy all your live keys here."/></label>
										...
										<div id="ps_braintree_test_keys">
											...
											<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="You need to signup for Braintree Sandbox account to use this. If enabled, all credit card transactions won't go through the actual credit card network. You can use some test cards numbers (provided by Braintree) to simulate a successful transaction."/>
											<div id="ps_braintree_test_keys_div" <?php if(empty($payment_properties->braintree_enable_test_mode)){ echo 'style="display: none;"'; } ?>>
													<label class="description" for="ps_braintree_test_merchant_id">Sandbox Merchant ID <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="These are API keys provided by Braintree. You can see all your keys in your Braintree control panel. Login to your Braintree account and go to 'Your Username' -> 'My User' -> 'API Keys'. Copy all your sandbox keys here."/></label>
									...
									<div id="ps_stripe_options" class="merchant_options" <?php if($payment_properties->merchant_type != 'stripe'){ echo 'style="display: none"'; } ?>>
										<div id="ps_stripe_live_keys" <?php if(!empty($payment_properties->stripe_enable_test_mode)){ echo 'style="display: none;"'; } ?>>
											<label class="description" for="ps_stripe_live_secret_key">Live Secret Key <span class="required">*</span> <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="These are keys provided by Stripe. You can see all your keys in your Stripe dashboard. Login to your Stripe account and go to 'Your Account' -> 'Account Settings' -> 'API Keys'. Copy all your Live keys here."/></label>
										...
										<div id="ps_stripe_test_keys">
											...
											<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="If enabled, all credit card transactions won't go through the actual credit card network. You can use some test cards numbers (provided by Stripe) to simulate a successful transaction."/>
											<div id="ps_stripe_test_keys_div" <?php if(empty($payment_properties->stripe_enable_test_mode)){ echo 'style="display: none;"'; } ?>>
													<label class="description" for="ps_stripe_test_secret_key" style="margin-top: 10px">Test Secret Key <img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="These are keys provided by Stripe. You can see all your keys in your Stripe dashboard. Login to your Stripe account and go to 'Your Account' -> 'Account Settings' -> 'API Keys'. Copy all your Test keys here."/></label>
							...
							<div id="ps_box_payment_options" class="ps_box_main gradient_blue">
								...
								<div class="ps_box_content">
									<div id="ps_currency_paypal_div" <?php if($payment_properties->merchant_type != 'paypal_standard'){ echo 'style="display: none"'; } ?>>
										...
										Currency
										<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Select the currency you would like to use to accept the payment from your clients."/>
										</label>
									...
									<div id="ps_optional_settings">
											...
											<div id="ps_discount_div" <?php if(empty($payment_properties->enable_discount)){ echo 'style="display: none"'; } ?>>
												<ul>
													...
													<li>
														...
														<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="The coupon can only be used this many times in total. Enter '0' for unlimited usage."/>
													</li>
										...
										<span id="ask_billing_span" class="ps_options_span stripe_option authorizenet_option paypal_rest_option braintree_option" <?php if(in_array($payment_properties->merchant_type,array('stripe','authorizenet','paypal_rest','braintree'))){ echo 'style="display: block"'; } ?>>
											...
											<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="If enabled, the payment page will prompt your clients to enter their billing address."/>
										</span>
										...
										<span id="ask_shipping_span" class="ps_options_span stripe_option authorizenet_option paypal_rest_option braintree_option" <?php if(in_array($payment_properties->merchant_type,array('stripe','authorizenet','paypal_rest','braintree'))){ echo 'style="display: block"'; } ?>>
											...
											<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="If enabled, the payment page will prompt your clients to enter their shipping address."/>
										</span>
										...
										<span id="save_cc_data_span" class="ps_options_span authorizenet_option" <?php if(in_array($payment_properties->merchant_type,array('authorizenet'))){ echo 'style="display: block"'; } ?>>
											...
											<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="If enabled, all your customers data (including credit card numbers) will be stored into your account on Authorized.net server. You need to enable CIM on your Authorize.net account to use this feature."/>
										</span>
