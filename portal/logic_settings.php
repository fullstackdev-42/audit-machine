 ...
 ********************************************************************************/
	...
	if(!empty($row)){
		...
		$jquery_data_code .= "\$('.logic_settings').data('logic_status',{\"logic_field_enable\": {$logic_field_enable} ,\"logic_page_enable\": {$logic_page_enable} ,\"logic_email_enable\": {$logic_email_enable},\"logic_webhook_enable\": {$logic_webhook_enable}});\n";
	}
						...
						<li>
							<div id="ls_box_field_rules" class="ns_box_main gradient_blue">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Enable this option to show or hide fields on the form based on the value of another fields. Useful for displaying different set of fields based on user choices."/>
								</div>
						...
						<li>
							<div id="ls_box_page_rules" class="ns_box_main gradient_blue">
								...
								<div class="ls_box_content" <?php if(empty($logic_page_enable)){ echo 'style="display: none"'; } ?>>
									...
									<label style="color: #80b638" class="description">Page rules unavailable! <br>You need to add one or more pages into your form.</label>
									<?php } else{ ?>
						...
						<li>
							<div id="ls_box_email_rules" class="ns_box_main gradient_blue">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="Enable this option to send additional notification emails to any email address based on user choices. You can customize the email content, subject, and from address based on user choices."/>
								</div>
						...
						<li>
							<div id="ls_box_webhook_rules" class="ns_box_main gradient_blue">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="images/navigation/005499/16x16/Help.png" style="vertical-align: top" title="This is ADVANCED option. Enable this option to send additional webhooks to any other URLs based on user choices."/>
								</div>
																	...
																	<td>
																		...
																		<div class="ls_webhook_options" id="ls_webhook_options_div_<?php echo $rule_id; ?>">
																			...
																			<div class="ls_webhook_options_body">
																				...
																				<span class="ns_temp_vars"><img style="vertical-align: middle" src="images/icons/70_green_white.png"> You can insert <a href="#" class="tempvar_link">template variables</a> into parameter values or data.</span>
																			</div> 
																		</div>
																	</td>
																</tr>
